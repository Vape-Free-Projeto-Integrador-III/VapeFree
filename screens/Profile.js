                    ...
                    <>
                        ...
                        >
                            <View style={[styles.avatar, { backgroundColor: cores.primaryLight }]}>
                                <Text style={[styles.avatarText, { color: cores.primaryDark }]}>
                                    G
                                </Text>
                            </View>

                            <Text style={[styles.name, { color: cores.text }]}>
                                Você tá como convidado
                            </Text>
                            <Text style={[styles.guestText, { color: cores.textMuted }]}>
                                Entra ou cria uma conta pra não perder seu progresso — seus dados
                        ...
                        <View style={styles.guestActions}>
                            ...
                            <TouchableOpacity
                                style={[
                                    ...
                                    { borderColor: cores.primary, backgroundColor: cores.card },
                                    SOMBRA.pequena,
                                ]}
                        ...
                        >
                            <View style={styles.infoRow}>
                                ...
                                <View style={styles.infoTextWrap}>
                                    <Text style={[styles.infoLabel, { color: cores.textMuted }]}>
                                        Modo convidado
                                    </Text>
                                    <Text style={[styles.infoValue, { color: cores.text }]}>
                                        Seus dados ficam só neste aparelho até você entrar numa
                                        conta.
                                    </Text>
                                </View>
                            </View>
