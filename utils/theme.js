...
export const DISTRACOES = [
    {
        id: 'agua',
        rotulo: 'Beber um copo de água',
        emoji: '💧',
        detalhe: 'Devagar, gole por gole. Ocupa a boca e as mãos.',
    },
    {
        id: 'caminhar',
        rotulo: 'Dar uma volta de 5 min',
        emoji: '🚶',
        detalhe: 'Sai do ambiente onde a vontade apareceu.',
    },
    {
        id: 'musica',
        rotulo: 'Ouvir uma música inteira',
        emoji: '🎧',
        detalhe: 'Uma música dura mais que o pico da fissura.',
    },
    {
        id: 'ligar',
        rotulo: 'Ligar pra alguém',
        emoji: '📞',
        detalhe: 'Não precisa nem falar do vape. Só conversa.',
    },
    {
        id: 'banho',
        rotulo: 'Tomar um banho frio',
        emoji: '🚿',
        detalhe: 'Choque de temperatura corta o ciclo da ansiedade.',
    },
    {
        id: 'mao',
        rotulo: 'Ocupar as mãos',
        emoji: '🤲',
        detalhe: 'Lavar louça, arrumar algo, apertar uma bolinha.',
    },
];
